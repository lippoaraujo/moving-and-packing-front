                    ...
                    <!--<VueSignaturePad 
                      ...
                      :options="{
                        onBegin: () => {
                          ...
                          $refs.signaturePad.fromDataURL(base64ImagemExistente)
                        }
                      }" /> -->
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      //let dados = this.$refs.signaturePad.fromData("image/svg+xml");
      //console.log(dados);
    },
    ...
    loadImage: function () {
      ...
      this.$refs.signaturePad.fromDataURL(this.base64ImagemExistente);
      console.log("aqui2");
    },
